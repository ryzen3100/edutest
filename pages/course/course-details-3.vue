                    ...
                    <div class="col-lg-8">
                        <div class="course-details-content course-details-3">
                            <div class="entry-content">
                                ...
                                <div class="thumbnail">
                                    <img src="/images/course/course-47.jpg" alt="Course">
                            ...
                            <div class="course-enroll-box">
                                <div class="single-item">
                                    <h6 class="title">Current Status</h6>
                                    <span class="enroll-status">Not Enrolled</span>
                                </div>
                                ...
                                <div class="single-item">
                                    ...
                                    <a href="#" class="edu-btn btn-medium enroll-btn">Take This Course</a>
                                    <div class="login-btn">
                                        <span>or</span>
                                        <a href="#">Login</a>
                                    </div>
                            ...
                            <div class="nav-tab-wrap">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="overview-tab" data-bs-toggle="tab" data-bs-target="#overview" type="button" role="tab" aria-controls="overview" aria-selected="true">Course</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="carriculam-tab" data-bs-toggle="tab" data-bs-target="#carriculam" type="button" role="tab" aria-controls="carriculam" aria-selected="false">Materials</button>
                                    </li>
                                </ul>
                                ...
                                <div class="inner">
                                    <div class="content">
                                        ...
                                        <ul class="course-item">
                                            ...
                                            <li>
                                                <span class="label">
                                                    <inline-svg src="/images/svg-icons/books.svg" alt="book icon" />Lessons:
                                                </span>
