...
import nuxt_plugin_plugin_043244bd from 'nuxt_plugin_plugin_043244bd' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginserver_e2a717ee from 'nuxt_plugin_pluginserver_e2a717ee' // Source: ./color-mode/plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_28f30281 from 'nuxt_plugin_pluginclient_28f30281' // Source: ./color-mode/plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_043244bd === 'function') {
    await nuxt_plugin_plugin_043244bd(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_e2a717ee === 'function') {
    await nuxt_plugin_pluginserver_e2a717ee(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_28f30281 === 'function') {
    await nuxt_plugin_pluginclient_28f30281(app.context, inject)
  }
